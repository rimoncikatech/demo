		...
		<main>
			<section class="faculty_members_cse">
				<div class="facalty_container">
					...
					<h2 class="faculty_title"><span class="toggle"><i class="fa fa-bars" aria-hidden="true"></i></span>Public Relation</h2>
					<center>
						<img alt="pro" height="223" src="{{asset('asset/img/tpic/EEE/hasib.png')}}" title="pro ius" width="220" />
						<h3>Abdul Hasib Siddique</h3>
						<h3>Chief Coordinating Officer</h3>
						<h3>Email: <a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="8aebe8eeffe6a4e2ebf9e3e8cae3fff9a4efeeffa4e8ee">[email&#160;protected]</a></h3>
						<br /><br />
						<hr />
						<img alt="PRO" height="223" src="#" title="" width="220" />
						<h3>Zahorul Hoque</h3>
						<h3>PRO & Assistant Director(Admin)</h3>
						<br /><br />
						<hr />
					</center>
				</div>
