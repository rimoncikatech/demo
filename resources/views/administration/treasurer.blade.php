		...
		<main>
			<section class="faculty_members_cse">
				<div class="facalty_container">
					...
					<h2 class="faculty_title"><span class="toggle"><i class="fa fa-bars" aria-hidden="true"></i></span>Treasurer</h2>
					<center>
						<img alt="vc" height="223" src="{{('asset/img/tpic/BBA/jali.jpg')}}" title="Treasurer IUS" width="220" />
						<h3>Md. Julfikar Ali</h3>
						<h3>Treasurer Incharge</h3>
						<h3>University of Scholars</h3>
						<h3>Name : Md. Julfikar Ali</h3>
					</center>
				  </div>
			</section>
		</main>
