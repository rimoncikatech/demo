		...
		<main>
			<section class="faculty_members_cse">
				<div class="facalty_container">
					...
					<h2 class="faculty_title"><span class="toggle"><i class="fa fa-bars" aria-hidden="true"></i></span>Branding</h2>
					<center>
						<img alt="vc" height="223" src="{{('asset/img/tpic/BBA/atif.jpg')}}" title="deputy controller" width="220" />
						<h3>H M Atif Wafik</h3>
						<h3>Head of Branding</h3>
						<h3>Email: <a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="3f5e4b56597f564a4c115a5b4a115d5b">[email&#160;protected]</a></h3>
						<br /><br />
						<hr />
					</center>
				</div>
