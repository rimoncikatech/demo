		...
		<main>
			<section class="faculty_members_cse">
				<div class="facalty_container">
					...
					<h2 class="faculty_title"><span class="toggle"><i class="fa fa-bars" aria-hidden="true"></i></span>Proctor</h2>
					<center>
						<img alt="vc" height="223" src="{{asset('asset/img/tpic/BBA/jali.jpg')}}" title="registrar" width="220" />
						<h3>Md. Julfikar Ali</h3>
						<h3>Proctor Incharge </h3>
