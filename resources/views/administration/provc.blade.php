		...
		<main>
			<section class="faculty_members_cse">
				<div class="facalty_container">
					...
					<h2 class="faculty_title"><span class="toggle"><i class="fa fa-bars" aria-hidden="true"></i></span>Pro Vice Chancellor</h2>
					<center>
						<img alt="vc" height="223" src="{{asset('asset/img/tpic/EEE/Din.jpg')}}" title="Vice Chancellor" width="220" />
						<h3>DR MD MAMUNUR RASHID</h3>
						<h3>Pro Vice Chancellor</h3>
						<h3>University of Scholars</h3>
						<h3>Name: DR MD MAMUNUR RASHID</h3>
					</center>
				  </div>
			</section>
		</main>
